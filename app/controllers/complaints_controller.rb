class ComplaintsController < ApplicationController
  ...
  private
    ...
    def complaint_params
      params.require(:complaint).permit(:product, :complain_what_happened, :issue, :sub_product, :zip_code, :tags, :complaint_id, :timely, :consumer_consent_provided, :company_response, :submitted_via, :company, :date_received, :state, :consumer_disputed, :company_public_response, :sub_issue)
    end
end
